...
public class Runner {
    ...
    public static final String SEDANS_FILE_PATH = "pre-selection_tasks\\resources\\Sedans.txt";
    public static final String CABRIOLETS_FILE_PATH = "pre-selection_tasks\\resources\\Cabriolets.txt";
    public static final String CROSSOVERS_FILE_PATH = "pre-selection_tasks\\resources\\Crossovers.txt";
    public static final String TRUCKS_FILE_PATH = "pre-selection_tasks\\resources\\Trucks.txt";
