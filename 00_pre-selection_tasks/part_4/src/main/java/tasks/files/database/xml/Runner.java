...
////                                                                                                             ////
////    В программе можно выбрать источник для чтения данных:                                                    ////
////    1. txt файл                                                                                              ////
...
public class Runner {
    ...
    // ======================================== Paths to files =======================================================
    private static final String DATABASE_PROPERTIES = "00_pre-selection_tasks\\dbproperties\\database.prop";

    public static final String SEDANS_FILE_PATH = "00_pre-selection_tasks\\resources\\Sedans.txt";
    public static final String CABRIOLETS_FILE_PATH = "00_pre-selection_tasks\\resources\\Cabriolets.txt";
    public static final String CROSSOVERS_FILE_PATH = "00_pre-selection_tasks\\resources\\Crossovers.txt";
    public static final String TRUCKS_FILE_PATH = "00_pre-selection_tasks\\resources\\Trucks.txt";

    private static final String CARS_INFO_XML = "00_pre-selection_tasks\\resources\\Cars.xml";
